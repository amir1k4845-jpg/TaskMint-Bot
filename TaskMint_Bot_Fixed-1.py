...
REQUIRED_CHANNELS = [
    ("@Amir10m300", "https://t.me/Amir10m300"),
    ("@TaskMint_v1", "https://t.me/TaskMint_v1"),
    ("@focusyour_dream", "https://t.me/focusyour_dream"),
    ("@update_your_life29", "https://t.me/update_your_life29")
]
    ...
    try:
        ...
        await context.bot.send_message(
            ...
            (
                ...
                "Your referred user joined all required channels and passed verification.\n"
...
def join_keyboard():
    ...
    for index, (_, link) in enumerate(REQUIRED_CHANNELS, start=1):
        buttons.append([
...
async def is_channel_member(
    ...
    try:
        ...
        print(
            f"Channel check error for {channel_username}:",
            error
        )
        return False


async def are_all_required_channels_joined(
    bot,
    user_id
):
...
async def start(
    ...
    if not await are_all_required_channels_joined(
        context.bot,
        user.id
    ):
        ...
        await update.message.reply_text(
            (
                "👋 <b>Hi dear user!</b>\n\n"
                "Please join all 4 required channels below, "
                "then press <b>Done / Verify</b>."
            ),
...
async def check_join(
    ...
    if not await are_all_required_channels_joined(
        ...
        await query.answer(
            "❌ Please join all 4 required channels first.",
            show_alert=True
        )
...
def main():
    ...
    print(
        ...
        "with cleaned user/admin menu system..."
    )
