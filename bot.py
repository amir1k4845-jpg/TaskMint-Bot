...
def setup_database():
    ...
    print("MongoDB database ready[span_0](start_span)[span_0](end_span).")
...
async def is_channel_member(bot, user_id):
    """শক্তিশালী চ্যানেল মেম্বারশিপ চেক (জয়েন না থাকলে False রিটার্ন করবে)"""
    try:
...
async def complete_task(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # বাধ্যতামূলক চ্যানেল মেম্বারশিপ চেক (জয়েন করা না থাকলে টাস্ক কমপ্লিট হবে না)
    member = await is_channel_member(context.bot, user_id)
    if not member:
        await query.answer("❌ You must join our channel first to complete this task!", show_alert=True)
        return
